...
function togNerv(){
  ...
  try{map.setFog(nervMode?
    {color:'rgba(60,28,4,1)',"high-color":'rgba(80,35,6,1)',"horizon-blend":0.06,"space-color":'#1a0c00',"star-intensity":0.2}:
    {color:'rgba(4,28,14,1)',"high-color":'rgba(6,35,18,1)',"horizon-blend":0.06,"space-color":'#000c1a',"star-intensity":0.2}
  );}catch(e){}
}
